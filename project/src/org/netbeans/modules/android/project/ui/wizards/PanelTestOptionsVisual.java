...
class PanelTestOptionsVisual extends SettingsPanel {
  ...
  void store(WizardDescriptor d) {
    d.putProperty( /*XXX Define somewhere */"setAsMain",  // NOI18N
        Boolean.valueOf(setAsMainCheckBox.isSelected() && setAsMainCheckBox.isVisible()));
  ...
  private void onMainProjectModified() {
    ...
    ManifestData manifestData = AndroidProjectUtil.parseProjectManifest(project);
