 ...
 */
final class AndroidProjectImpl implements AndroidProject {
  ...
  @Override
    ...
    private Lookup createLookup() {
        ...
        AndroidProjectEncodingQueryImpl fileEncoding = new AndroidProjectEncodingQueryImpl();
        ...
        Lookup base = Lookups.fixed(
            ...
            new AndroidLauncherImpl(), auxProps,
