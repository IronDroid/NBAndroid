...
class UIClassDescriptors {
  ...
  static Iterable<UIClassDescriptor> findBySimpleName(
  ...
  static UIClassDescriptor findByFQName(
  ...
  static UIClassDescriptor findParamsForName(
