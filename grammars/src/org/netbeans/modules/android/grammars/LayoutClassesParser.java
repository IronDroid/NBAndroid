...
/**
 * Class to parse widgets.txt file from SDK that contains info about class type and its inheritance tree.
 * 
 * Each line is in the following format<br/>
 * {@code [code][class name] [super class name] [super class name]...}
 * where code is a single letter (W for widget, L for layout, P for layout parameters), and class names
 * 
 * Cf. WidgetClassLoader in ADT plugin.
 * @author radim
 */
class LayoutClassesParser {
