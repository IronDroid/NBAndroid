...
public enum Tool {
  ...
  // in platform-tools since android-9, in platforms/android-<version>/tools
  PACKAGER("aapt", "platform-tools", "tools"),
  // in platform-tools since android-9, in platforms/android-<version>/tools
  COMPILER("dx", "platform-tools", "tools"),
  APKBUILDER("apkbuilder", "tools"),
